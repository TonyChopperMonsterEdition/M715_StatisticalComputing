...
expenditure4Education$CulturalTotalExpenditure<- as.double(gsub(",",".",expenditure4Education$CulturalTotalExpenditure))*(10^3)
expenditure4Education[,1:3] <- lapply(expenditure4Education[,1:3], factor)


# GENESIS-Tabelle: 82111-0001 import of gross domestic product at Market Price
