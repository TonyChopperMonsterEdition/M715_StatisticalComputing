...
# Vorwort {.unnumbered}
This paper was created with Rmarkdown. All data that was used to build this paper are also available in [Github](https://github.com/TonyChopperMonsterEdition/M715_StatisticalComputing/tree/2536b0a7dfc4fa8ccc7150315d5f05941734e835/M715_Hausarbeit). This includes the Data from the Federal Criminal Police Office and the Federal Statistical Office from Germany, the Rmarkdown-File or any artifact that was build or used by the RMarkdown-File. You are free to use any of the data inside and made your own calculations. Especially the Data from the german offices are [licenced](https://www.govdata.de/dl-de/by-2-0) for an open commercial and non-commericial use.
Additionally you will find a german and a english version of this rmarkdown in the Repository, the english version does not have any extentions in his filename. In the **08_Report** folder you find two HTML Files, which results from the rmarkdown.  
<ul>
