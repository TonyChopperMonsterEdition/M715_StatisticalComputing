...
Beispiel <- caseNumbers_2014[caseNumbers_2014$Straftat %like% "Diebstahl unter " & caseNumbers_2014$Bundesland %like% "echte",]
Diebstähle <- as.numeric(caseNumbers_2014$'erfasste Fälle'[caseNumbers_2014$Straftat %like% "Diebstahl unter" & caseNumbers_2014$Bundesland %like% "echte"])
```
