...
regressionModel_2 <- lm(TheftAmount ~ Population + GDP + AmountOfUnemployedPeople + TotalExpenditure4Education + CulturalTotalExpenditure + Areasize + Year  -1, data=mergedData4regression[,-1])

print("##### Model 3 ######")

regressionModel_3 <- plm(TheftAmount ~ Population + GDP + AmountOfUnemployedPeople + TotalExpenditure4Education + CulturalTotalExpenditure, data=mergedData4regression[,-1], index = c( "Areasize","Year"), model = "within", effect = "twoways")

print("##### Model 4 ######")


regressionModel_4 <- plm(TheftAmount ~ Population + GDP + AmountOfUnemployedPeople + TotalExpenditure4Education + CulturalTotalExpenditure, index = c("FederalState", "Year"), model = "within", effect = "twoways", data=mergedData4regression[,-4])
...
d
`r regressionModel_1[1]$coefficients `
d
`r regressionModel_2[1]$coefficients `
d
`r regressionModel_3[1]$coefficients `
D
`r regressionModel_4[1]$coefficients `
d
...
coeftest(regressionModel_1, vcov = vcovHC, type = "HC1")

linearHypothesis(regressionModel_1,
                 test = "F",
...
linearHypothesis(regressionModel_2,
                 test = "F",
                 c("AmountOfUnemployedPeople=0", "TotalExpenditure4Education=0", "CulturalTotalExpenditure=0"), 
                 vcov. = vcovHC, type = "HC1")
...
^[https://www.econometrics-with-r.org/10.4-regression-with-time-fixed-effects.html entity and time fixed effects]
