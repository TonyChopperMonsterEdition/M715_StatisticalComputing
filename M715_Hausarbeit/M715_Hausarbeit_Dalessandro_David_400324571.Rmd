...
print("##### Model 3 ######")
print("##### ####### ######")
regressionModel_3 <- plm(TheftAmount ~ Population + GDP + AmountOfUnemployedPeople + TotalExpenditure4Education + CulturalTotalExpenditure, data=mergedData4regression[,-1], index = c("Year", "Areasize"), model = "within")
...
regressionModel_4 <- plm(TheftAmount ~ Population + GDP + AmountOfUnemployedPeople + TotalExpenditure4Education + CulturalTotalExpenditure, index = c("FederalState", "Year"), model = "within", data=mergedData4regression[,-4])
...
regressionModel_5 <- plm(TheftAmount ~ TotalExpenditure4Education, index = c("FederalState", "Year", "Areasize"), model = "within", data=mergedData4regression)

summary(regressionModel_5)

coeftest(regressionModel_5, vcov = vcovHC, type = "HC1")

linearHypothesis(regressionModel_5,
                 test = "F",
                 c("TotalExpenditure4Education=0"), 
                 vcov. = vcovHC, type = "HC1")
