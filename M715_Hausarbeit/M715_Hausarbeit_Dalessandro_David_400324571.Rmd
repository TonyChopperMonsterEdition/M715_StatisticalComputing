...
\t `r knitr::kable(caseNumbers_2014[caseNumbers_2014$Straftat %like% "Diebstahl unter" & caseNumbers_2014$Bundesland %like% "echte",])`
`r caseNumbers_2014$'erfasste Fälle'[caseNumbers_2014$Straftat %like% "Diebstahl unter" & caseNumbers_2014$Bundesland %like% "echte"]` Diebstähle erfasst wurden, die von einer Person in mehreren Bundesländern verübt wurden. Diese werden aber nicht in den jeweils einzelnen Posten der Bundesländer, sondern in diesem Sammelposten geführt.-->
